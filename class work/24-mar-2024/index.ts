...
let yourname:string= "Rafaqat Ali";
...
let firstname :string = "Rafaqat";

let lastname:string = "Ali";

let fullname4:string=`${firstname} ${lastname}`;
...
let productname:string ="Thinkpad";

let productprice:number =421000.50;
...
let today_temperature:number= 27;
